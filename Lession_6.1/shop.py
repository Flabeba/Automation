...
#driver.find_element(By.NAME, form_delivery[0]).send_keys(datas[0])
#driver.find_element(By.NAME, form_delivery[1]).send_keys(datas[1])
#driver.find_element(By.NAME, form_delivery[2]).send_keys(datas[2])
